...
Game.level1.prototype = {
    ...
    //Score
     getCoin:function(){
        ...
        glob_score = CoinCount * 10;
         
    },
    
    //Finish
    victory_level:function(){
        this.state.start('Preloader2');
    },
    ...
    create:function(){
        ...
        map.setTileIndexCallback(14,this.victory_level,this);
        ...
        controls = {
            ...
            admin: this.input.keyboard.addKey(Phaser.Keyboard.P)
        };
    ...
    update: function () {
       ...
       if(controls.admin.isDown){
           player.reset(2000,100);
       }
